...
//                             .react-calendar__tile--active {
//                                 background: rgba(0, 123, 255, 0.7); /* Active tile with a blue tint */
//                                 color: white;
//                                 border-radius: 10px; /* Optional: Rounded corners */
//                             }

//                             .react-calendar__tile--now {
//                                 background: rgba(0, 123, 255, 0.5); /* Grey for the "today" tile */
//                             }

//                             .react-calendar__tile--month {
//                                 color: #333; /* Regular tile text color */
//                             }
