...
const AirDashboard = () => {
    ...
    const thresholds = {
        pm25: [
            ...
            { min: 46, max: 55.99, label: "Very Unhealthy", color: "rgba(230, 139, 41)" },
        ...
        pm10: [
            ...
            { min: 151, max: 200.99, label: "Very Unhealthy", color: "rgba(230, 139, 41)" },
        ...
        humidity: [
            ...
            { min: 71, max: Infinity, label: "Poor", color: "rgba(230, 139, 41)" },
        ],
        temperature: [
            ...
            { min: 55, max: Infinity, label: "Extreme", color: "rgba(230, 139, 41)" },
        ],
        oxygen: [
            { min: 0, max: 19.49, label: "Poor", color: "rgba(230, 139, 41)" },
    ...
    const thresholds1 = {
        ...
        pm10: [
            ...
            { min: 201, max: 300.99, label: "Acutely Unhealthy", color: "rgba(185, 99, 255)" },
